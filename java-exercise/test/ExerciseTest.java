...
public class ExerciseTest {
	...
	/**
     * Test of divideIntRoundUp method, of class Exercise.
     */
    @Test
    public void testDivideIntRoundUp() {
    		assertEquals(new Integer(4), Exercise.divideIntRoundUp(10,3));
    		assertEquals(new Integer(3), Exercise.divideIntRoundUp(9,3));
    		assertEquals(new Integer(-4), Exercise.divideIntRoundUp(-10,3));
    		assertEquals(new Integer(-3), Exercise.divideIntRoundUp(9,-3));
    		assertEquals(new Integer(4), Exercise.divideIntRoundUp(-10,-3));
    		assertNull(Exercise.divideIntRoundUp(-10,0));
    		assertEquals(new Integer(0), Exercise.divideIntRoundUp(0,3));
    }
